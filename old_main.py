...
class NXSWriter:
    ...
    def write(self, output_path: str, scans: List[Scan], echem_df: pd.DataFrame) -> None:
...
class NXSGeneratorGUI:
    ...
    def setup_ui(self) -> None:
        ...
        self.progress_bar.grid(row=14, column=0, columnspan=3, sticky=(tk.W, tk.E), pady=(0, 5))

        self.progress_label = ttk.Label(main_frame, textvariable=self.progress_text)
        self.progress_label.grid(row=15, column=0, columnspan=3, pady=(0, 10))

        # Action buttons
        button_frame = ttk.Frame(main_frame)
        button_frame.grid(row=16, column=0, columnspan=3, pady=(10, 0))
